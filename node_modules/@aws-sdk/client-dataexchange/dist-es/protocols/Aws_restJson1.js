...
export const serializeAws_restJson1CreateDataSetCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {
...
export const serializeAws_restJson1CreateEventActionCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {
        "content-type": "application/json",
    };
...
export const serializeAws_restJson1CreateRevisionCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {
        "content-type": "application/json",
    };
...
export const serializeAws_restJson1DeleteEventActionCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {};
...
export const serializeAws_restJson1DeleteRevisionCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {};
    let resolvedPath = `${basePath?.endsWith("/") ? basePath.slice(0, -1) : basePath || ""}` +
...
export const serializeAws_restJson1GetAssetCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {};
    let resolvedPath = `${basePath?.endsWith("/") ? basePath.slice(0, -1) : basePath || ""}` +
        "/v1/data-sets/{DataSetId}/revisions/{RevisionId}/assets/{AssetId}";
...
export const serializeAws_restJson1GetDataSetCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {};
    let resolvedPath = `${basePath?.endsWith("/") ? basePath.slice(0, -1) : basePath || ""}` + "/v1/data-sets/{DataSetId}";
    resolvedPath = __resolvedPath(resolvedPath, input, "DataSetId", () => input.DataSetId, "{DataSetId}", false);
...
export const serializeAws_restJson1GetEventActionCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {};
    let resolvedPath = `${basePath?.endsWith("/") ? basePath.slice(0, -1) : basePath || ""}` + "/v1/event-actions/{EventActionId}";
    resolvedPath = __resolvedPath(resolvedPath, input, "EventActionId", () => input.EventActionId, "{EventActionId}", false);
...
export const serializeAws_restJson1GetRevisionCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {};
    let resolvedPath = `${basePath?.endsWith("/") ? basePath.slice(0, -1) : basePath || ""}` +
        "/v1/data-sets/{DataSetId}/revisions/{RevisionId}";
...
export const serializeAws_restJson1ListDataSetRevisionsCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {};
    let resolvedPath = `${basePath?.endsWith("/") ? basePath.slice(0, -1) : basePath || ""}` + "/v1/data-sets/{DataSetId}/revisions";
    resolvedPath = __resolvedPath(resolvedPath, input, "DataSetId", () => input.DataSetId, "{DataSetId}", false);
...
export const serializeAws_restJson1ListEventActionsCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {};
    const resolvedPath = `${basePath?.endsWith("/") ? basePath.slice(0, -1) : basePath || ""}` + "/v1/event-actions";
    const query = map({
...
export const serializeAws_restJson1ListRevisionAssetsCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {};
    let resolvedPath = `${basePath?.endsWith("/") ? basePath.slice(0, -1) : basePath || ""}` +
...
export const serializeAws_restJson1RevokeRevisionCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {
        "content-type": "application/json",
    };
...
export const serializeAws_restJson1SendApiAssetCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
...
export const serializeAws_restJson1StartJobCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {};
    let resolvedPath = `${basePath?.endsWith("/") ? basePath.slice(0, -1) : basePath || ""}` + "/v1/jobs/{JobId}";
    resolvedPath = __resolvedPath(resolvedPath, input, "JobId", () => input.JobId, "{JobId}", false);
...
export const serializeAws_restJson1UpdateAssetCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {
        "content-type": "application/json",
    };
...
export const serializeAws_restJson1UpdateDataSetCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {
        "content-type": "application/json",
    };
...
export const serializeAws_restJson1UpdateEventActionCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {
        "content-type": "application/json",
    };
...
export const serializeAws_restJson1UpdateRevisionCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {
        "content-type": "application/json",
    };
...
export const deserializeAws_restJson1CreateDataSetCommand = async (output, context) => {
...
export const deserializeAws_restJson1CreateEventActionCommand = async (output, context) => {
    if (output.statusCode !== 201 && output.statusCode >= 300) {
...
export const deserializeAws_restJson1CreateRevisionCommand = async (output, context) => {
    if (output.statusCode !== 201 && output.statusCode >= 300) {
...
export const deserializeAws_restJson1DeleteEventActionCommand = async (output, context) => {
    if (output.statusCode !== 204 && output.statusCode >= 300) {
...
export const deserializeAws_restJson1DeleteRevisionCommand = async (output, context) => {
    if (output.statusCode !== 204 && output.statusCode >= 300) {
...
export const deserializeAws_restJson1GetAssetCommand = async (output, context) => {
...
export const deserializeAws_restJson1GetDataSetCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
export const deserializeAws_restJson1GetEventActionCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
export const deserializeAws_restJson1GetRevisionCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
export const deserializeAws_restJson1ListDataSetRevisionsCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
export const deserializeAws_restJson1ListEventActionsCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
export const deserializeAws_restJson1ListRevisionAssetsCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
export const deserializeAws_restJson1RevokeRevisionCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
export const deserializeAws_restJson1SendApiAssetCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
export const deserializeAws_restJson1StartJobCommand = async (output, context) => {
...
export const deserializeAws_restJson1UpdateAssetCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
export const deserializeAws_restJson1UpdateDataSetCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
export const deserializeAws_restJson1UpdateEventActionCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
export const deserializeAws_restJson1UpdateRevisionCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
