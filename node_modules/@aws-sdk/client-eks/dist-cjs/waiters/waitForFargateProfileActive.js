...
exports.waitUntilFargateProfileActive = exports.waitForFargateProfileActive = void 0;
const util_waiter_1 = require("@aws-sdk/util-waiter");
const DescribeFargateProfileCommand_1 = require("../commands/DescribeFargateProfileCommand");
const checkState = async (client, input) => {
    let reason;
    try {
        const result = await client.send(new DescribeFargateProfileCommand_1.DescribeFargateProfileCommand(input));
        reason = result;
        try {
